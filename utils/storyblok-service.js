...
class StoryblokService {
  constructor() {
    ...
    this.token = "Y8uvIKFxiCCssMS546sFmAtt";
  ...
  // ask Storyblok's Content API for the content of story
  ...
  get(slug, params) {
    ...
    if (
      ...
      typeof window.StoryblockCacheVersion !== "undefined"
    ) {
      params.cv = window.StoryblockCacheVersion;
    }
